...
export default function LoadingPage() {
  ...
  useEffect(() => {
    if (showResults) {
      setTimeout(() => {
        // Redirect to the final offer page. Using '/' as a placeholder.
        router.push('/'); 
      }, 8000); // Show results for 8 seconds before redirecting
    }
  }, [showResults, router]);
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white text-center px-4 sm:px-6 lg:px-8 py-8">
      <main className="flex flex-col items-center justify-center flex-grow w-full max-w-3xl space-y-6">
        ...
        {!showResults ? (
          <div className="flex flex-col items-center justify-center w-full max-w-md space-y-6 animate-in fade-in duration-500">
