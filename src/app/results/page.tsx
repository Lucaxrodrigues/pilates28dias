...
export default function ResultsPage() {
  return (
    <div className="flex flex-col items-center min-h-screen bg-white px-4 py-8 sm:px-6 lg:px-8">
      <main className="flex flex-col items-center w-full max-w-3xl space-y-6 animate-in fade-in duration-700">
        ...
        <div className="w-full space-y-4">
          <Card className="border-2 border-[#E836D7]">
            <CardHeader className="flex flex-row items-center space-x-3 pb-2">
              <CheckSquare className="w-8 h-8 text-white bg-blue-500 rounded-md p-1" />
          ...
          <Card className="border-2 border-[#E836D7]">
            <CardHeader className="flex flex-row items-center space-x-3 pb-2">
              <CheckSquare className="w-8 h-8 text-white bg-green-500 rounded-md p-1" />
        ...
        <Link href="#" passHref className="w-full max-w-lg">
          <Button
            size="lg"
