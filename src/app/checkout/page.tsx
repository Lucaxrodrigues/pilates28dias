...
export default function CheckoutPage() {
  const [checkoutUrl, setCheckoutUrl] = useState(
    'https://pay.cakto.com.br/4hq9554_540351'
  );
  ...
  useEffect(() => {
    ...
    if (externalId) {
      setCheckoutUrl(
        `https://pay.cakto.com.br/4hq9554_540351?src=${externalId}`
      );
    }
  }, []);
      ...
      <div className="flex flex-col items-center min-h-screen bg-white text-center px-4 sm:px-6 lg:px-8 py-12">
        <main className="flex flex-col items-center justify-center w-full max-w-3xl space-y-8 animate-in fade-in duration-700">
          ...
          <h2 className="text-2xl font-bold underline">
            <span style={{ color: '#E836D7' }}>
              Programa Pilates na Parede Light 3.0
            </span>{' '}
            está mudando vidas
          </h2>
          ...
          <p className="text-base max-w-2xl">
            Nós preparamos seu programa personalizado com profissionais
            experientes e qualificados! Aulas com máxima qualidade, e tudo que
            te ensinamos e recomendamos é feito em base de anos de estudos e
          ...
          <Card className="border-2 border-green-500 w-full">
            ...
            <CardContent className="text-base text-left">
              <p>
                Mudar a vida do máximo de pessoas possíveis! Por isso, não
                queremos que o PREÇO seja uma barreira para você ter uma vida
                mais saúdavel, livre de dores, doenças e que você consiga
                rejuvenescer seu corpo!
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-green-500 w-full">
            ...
            <CardContent className="text-base text-left space-y-2">
              <p>
                Pensando em <span className="underline">você</span>, nós
                decidimos te dar essa oportunidade por um preço mais do que
                especial! Hoje você terá acesso ao{' '}
                <span
          ...
          <div className="w-full max-w-xl border-2 border-gray-200 rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="bg-[#F0FFF4] pb-4 text-center">
              <p className="text-lg">
                Ou apenas{' '}
                <strong className="text-green-600">7x de R$5,04</strong>
              </p>
            </div>
          </div>
